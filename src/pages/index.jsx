...
function Resume() {
  let resume = [
    {
      company: 'Just Understanding Data',
      title: 'Software Engineer',
      logo: logoJustUnderstanding,
      start: '2023',
      end: {
        label: 'Present',
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/Dans_cv.pdf" download target="_blank" rel="noreferrer noopener" variant="secondary" className="group mt-6 w-full">
        Download CV
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Daniel Hurst - Software Engineer
        </title>
        <meta
          name="description"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/danhursty"
              target="_blank"
            ...
            />
            <SocialLink
              href="https://instagram.com/danhursty"
              target="_blank"
              rel="noopener noreferrer"
            ...
            />
            <SocialLink
              href="https://github.com/danhursty"
              target="_blank"
              rel="noopener noreferrer"
